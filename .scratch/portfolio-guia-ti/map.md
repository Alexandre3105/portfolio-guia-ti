...
- A primeira trilha completa será **Redes para Suporte**.
...
- [Fixar produto, público, idioma e recorte do MVP](issues/02-fixar-produto-publico-idioma-e-mvp.md) — duas jornadas públicas em PT-BR, começando por uma trilha completa de redes para iniciantes.
...
- Quais módulos devem suceder a primeira trilha depois que o formato inicial estiver validado.
- Como separar o licenciamento do código do licenciamento dos artigos, exercícios e demais materiais autorais.
